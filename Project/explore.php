...
<style>
    .welcome-section {
        background: linear-gradient(rgba(0,0,0,0.7),rgba(0,0,0,0.7)), url('<?php echo $data['gambar']; ?>') no-repeat center center ;
    ...
    while($data = mysqli_fetch_assoc($result))
      {?>
        ...
        <img src="<?php echo $data['gambar']; ?>" alt="<?php echo $data['gambar']; ?>" class="property-image">
        <div class="property-content" data-value="">
            ...
            <a href="booking/transaksi.php?id=<?php echo $data['id_wisata'];?>" class="property-book-button">Book Now</a><br>
        </div>
    </div>
    <?php }
      ?>
